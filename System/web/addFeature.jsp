    ...
    <div class="container"> <br>  
                  ...
                  <div class="col-3"> &nbsp; &nbsp;<!-- CARD-->
                    <div class="card" style="width: 18rem; margin-left: 20px;"> 
                        ...
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item"><strong> Adding features to your profile is the easiest way for companies to find you.</strong></li>
                          <li class="list-group-item"><strong>Keep it up update!!</strong></li>
                        </ul>
                    </div> 
                  </div><!--END CARD-->
        ...
        <% if(!ITEMS.isEmpty()){ %> 
            ...
            <ul style="display: inline">
                ...
                <li class="path-item" style="display: inline;"> 
                    <a style="color: inherit; text-decoration: none;" title="Remove <%=of.getFeature().getName()%>" href="\System\rFilter?selectedValue=<%=ITEMS.indexOf(of)%>"> <%=of.getFeature().getName()%> </a> &nbsp;
                </li> &nbsp; &nbsp;
                <%}%> 
            </ul> <hr>
        <%}%>
            ...
            <ul> <!--Root Categories-->
                <% for(Feature f: roots){ %>
                    <li style="list-style:none; font-size: 20px;">
                           <%=f.getName()%> 
                           <% if(f.hasChilds()) { %>
                            <a href="\System\xFilter?selectedValue=<%=f.getName()%>"> <img src="images\expand.png" alt="(+)"> </a>
                           <% } %>
                    </li>
                <% } %>
        ...
        <ul><% if(!PATH.isEmpty()) { %>
            <li style="margin-bottom: 10px; list-style:none; font-size: 20px;">
                <a href="\System\cFilter?selectedValue=<%=PATH.peek()%>"> <img src="images\contract.png" alt="(-)"> </a>
                <%= PATH.peek() %>
            </li>
            <% } %>
        <ul>
            ...
            <li style="margin-bottom: 10px; list-style:none; font-size: 20px;">
                    <a style="color: inherit;" href="\System\dFilter?selectedValue=<%=f.getIdFeature()%>"> <%=f.getName()%> </a>
                    <% if(f.hasChilds()) { %>
                    <a href="\System\xFilter?selectedValue=<%=f.getName()%>"> <img src="images\expand.png" alt="(+)"> </a>
                    <% } %>
            </li>
        ...
        <!-- #END REGION LIST OF SUBCATEGORIES-->    
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="testOf" method="post">
                        <% int count =0; %>

            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"> <!--NAV BAR CONTENT-->
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="\System\AdminProfile"> Profile <span class="sr-only">(current)</span></a>
                    </li>
                    
                    <li class="nav-item active">
                        <a class="nav-link" href="\System\ShowFeatures"> Features Maintenance</a>
                    </li>  
                ...
                <div class="nav-item dropdown"> <!--LOGIN DROPDOWN-->
                    <a class="nav-link dropdown-toggle" href="\System\AdminProfile" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <%="ADMINISTRATOR"%>
                    </a>
